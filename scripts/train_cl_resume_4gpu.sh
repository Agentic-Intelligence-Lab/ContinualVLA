...
TASKS=(
    ...
    "pi05_piper_open_the_drawer_500_4cam_hold_dim7_13:${OPENPI_DATA_ROOT}/realworld_piper/open_the_drawer_500"
...
DATA_REPLAY_RATIO="${DATA_REPLAY_RATIO:-0.05}"
...
############################
GPUS="${OPENPI_GPUS:-0,1,2,3}"
NPROC="${OPENPI_NPROC:-4}"
