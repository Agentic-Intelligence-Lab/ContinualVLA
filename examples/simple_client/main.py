...
def _random_observation_r1lite() -> dict:
    obs = {
        "observation.state.left_arm": np.random.rand(6).astype(np.float32),
        "observation.state.right_arm": np.random.rand(6).astype(np.float32),
        "observation.state.left_arm.velocities": np.random.rand(6).astype(np.float32),
        "observation.state.right_arm.velocities": np.random.rand(6).astype(np.float32),
        "observation.state.chassis.imu": np.random.rand(10).astype(np.float32),
        "observation.state.chassis": np.random.rand(3).astype(np.float32),
        "observation.state.chassis.velocities": np.random.rand(3).astype(np.float32),
        "observation.state.torso": np.random.rand(4).astype(np.float32),
        "observation.state.torso.velocities": np.random.rand(4).astype(np.float32),
        "observation.state.left_gripper": np.random.rand(1).astype(np.float32),
        "observation.state.right_gripper": np.random.rand(1).astype(np.float32),
        "observation.state.left_ee_pose": np.random.rand(7).astype(np.float32),
        "observation.state.right_ee_pose": np.random.rand(7).astype(np.float32),

        "observation.images.head_rgb": np.random.randint(256, size=(224,224,3), dtype=np.uint8),
        "observation.images.left_wrist_rgb": np.random.randint(256, size=(224,224,3), dtype=np.uint8),
        "observation.images.right_wrist_rgb": np.random.randint(256, size=(224,224,3), dtype=np.uint8),

        "prompt": "Fold the green T-shirt",
    }
    return obs
