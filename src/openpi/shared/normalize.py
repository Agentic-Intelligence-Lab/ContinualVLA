...
class NormStats:
    ...
    vmin: numpydantic.NDArray | None = None
    vmax: numpydantic.NDArray | None = None
...
class RunningStats:
    ...
    def get_statistics(self) -> NormStats:
        ...
        return NormStats(mean=self._mean, std=stddev, q01=q01, q99=q99, vmin=self._min, vmax=self._max)
